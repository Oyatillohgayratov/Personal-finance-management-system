...
func Router(opt Options) *gin.Engine {
	...
	v1 := r.Group("/api/v1")
	{
		...
		v1.POST("/budgets", h.CreateBudgetForCategory)
		v1.GET("/budgets", h.GetBudgets)
		v1.PUT("/budgets/:budgetsId", h.PutBudget)
		...
		v1.GET("/reports/income-expense", h.GetRepoting)
		v1.GET("/reports/spending-by-category", h.GetRepotingByCategory)
	}
